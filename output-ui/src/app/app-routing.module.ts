...
const routes: Routes = [
  ...
  { path: 'administration', component: ExportComponent, canActivate: [LoginGuard], data: { roles: ['reader'] } },
  ...
  { path: 'administration/export', component: ExportComponent, canActivate: [LoginGuard], data: { roles: ['reader'] } },
