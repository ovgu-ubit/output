...
const routes: Routes = [
  ...
  { path: 'administration', component: ImportComponent, canActivate: [LoginGuard], data: { roles: ['writer'] } },
  { path: 'administration/plausibility', component: PlausibilityComponent, canActivate: [LoginGuard], data: { roles: ['writer'] } },
  { path: 'administration/import', component: ImportComponent, canActivate: [LoginGuard], data: { roles: ['writer'] } },
  { path: 'administration/enrich', component: EnrichComponent, canActivate: [LoginGuard], data: { roles: ['writer'] } },
  { path: 'administration/export', component: ExportComponent, canActivate: [LoginGuard], data: { roles: ['writer'] } },
