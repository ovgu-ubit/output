...
export class ImportWorkflow1769081242941 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "workflow_import" ("id" SERIAL NOT NULL, "workflow_id" integer NOT NULL, "label" character varying NOT NULL, "version" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "modified_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "published_at" TIMESTAMP WITH TIME ZONE, "deteted_at" TIMESTAMP WITH TIME ZONE, "description" character varying, "strategy_type" "public"."workflow_import_strategy_type_enum", "strategy" jsonb, CONSTRAINT "UQ_df41b3a5cdc3da7b056c9023304" UNIQUE ("workflow_id", "version"), CONSTRAINT "PK_4341ef4b7746690ac61dc9f536d" PRIMARY KEY ("id"))`);
    }
